...
const DS_PAGES = [
  {
    ...
    title: 'TW Theme',
    description: 'Teacher Workspace design tokens, color palette, and Shadcn component reference.',
    icon: Palette,
  },
  {
    to: '/ds/flow-components' as const,
    title: 'Flow Components',
    description: 'Interactive showcase of @flow/core components with TW/Flow theme switching.',
    icon: Component,
  },
  {
...
function DsIndexPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl p-8">
      ...
      <p className="mt-1 text-muted-foreground">Token references and component documentation.</p>
