...
export type StudentStatus = 'not_sent' | 'sent' | 'viewed' | 'acknowledged' | 'sent_to_parents';
export type SchoolLevel = 'primary' | 'secondary';

// Academic types
export type LearningOutcomeStatus = 'Accomplished' | 'Competent' | 'Developing' | 'Beginning';
...
export type SecondaryGrade = 'A1' | 'A2' | 'B3' | 'B4' | 'C5' | 'C6' | 'D7' | 'E8' | 'F9';
...
export interface SecondarySubjectPerformance {
  ...
  semesterHistory: SemesterResult[];
