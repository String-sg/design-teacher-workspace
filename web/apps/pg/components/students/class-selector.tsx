...
import { groupedClassOptions } from '~/apps/pg/data/mock-students';
...
export function ClassSelector({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-64 gap-0 overflow-hidden rounded-2xl p-0" align="start">
        {/* School level toggle */}
        ...
        <div className="max-h-72 overflow-y-auto p-1">
          ...
          <button
            ...
            className={cn(
              'inline-flex w-full items-center gap-2 rounded-lg p-2 text-base leading-6 font-medium text-muted-foreground outline-none hover:bg-accent hover:text-accent-foreground',
