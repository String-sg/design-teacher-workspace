import type { CoreValue } from '~/apps/pg/types/report';
...
export function RadarChart({ values, size = 250, colorScheme = 'pink' }: RadarChartProps) {
  const center = size / 2;
  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      ...
      <polygon points={dataPolygon} fill={colors.fill} stroke={colors.stroke} strokeWidth={2} />
