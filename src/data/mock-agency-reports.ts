...
export const AGENCY_TEMPLATES: Array<AgencyTemplate> = [
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            id: 'msf-fas',
            label: 'Financial Assistance Scheme',
            type: 'text',
            source: 'School Cockpit',
            value: 'MOE FAS',
          },
      ...
      {
        id: 'msf-school-info',
        title: 'School Performance & Behaviour',
        role: 'yh',
        fields: [
          {
            id: 'msf-attendance',
      ...
      {
        id: 'msf-counsellor',
        title: "Counsellor's Report",
        role: 'counsellor',
        fields: [
          {
            id: 'msf-interventions',
  ...
  {
    id: 'reach',
    agency: 'REACH (Response, Early intervention And Community mental Health)',
    name: 'REACH Student Information Form',
    abbrev: 'REACH',
    color: '#059669',
    totalFields: 22,
    autoFilled: 14,
  ...
  {
    id: 'children-home',
    agency: "Children's Home / Family Court",
    name: "School Report for Children's Home",
    abbrev: 'CH',
    color: '#d97706',
    totalFields: 38,
    autoFilled: 24,
  ...
  {
    id: 'navh',
    agency: 'National Addictions Management Service (NAVH)',
    name: 'NAVH School Report',
    abbrev: 'NAVH',
    color: '#0891b2',
    totalFields: 24,
    autoFilled: 16,
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            id: 'navh-risk',
            label: 'Substance-Related Risk Indicators',
            type: 'narrative',
            aiDraftable: true,
          },
        ],
      },
      {
        ...
        fields: [
          ...
          { id: 'navh-notes', label: 'Counselling Notes', type: 'narrative' },
        ],
      },
    ],
  },
  {
    id: 'assq',
    agency: 'Autism Resource Centre / CGC',
    name: 'ASSQ Autism Screening',
    abbrev: 'ASSQ',
    color: '#9333ea',
    totalFields: 30,
    autoFilled: 8,
  ...
  {
    id: 'sc-swo-a',
    agency: 'School Social Worker / MSF',
    name: 'SC-SWO Template A (Student known)',
    abbrev: 'SWO-A',
    color: '#0064ff',
    totalFields: 20,
    autoFilled: 14,
  ...
  },
  {
    id: 'sc-swo-b',
    agency: 'School Social Worker / MSF',
    name: 'SC-SWO Template B (Student not known)',
    abbrev: 'SWO-B',
    color: '#0064ff',
    totalFields: 18,
    autoFilled: 12,
  ...
  {
    id: 'intake',
    agency: 'Various (MSF / SSO)',
    name: 'Intake Assessment Part 1',
    abbrev: 'INTK',
    color: '#0064ff',
    totalFields: 24,
    autoFilled: 16,
  ...
  },
  {
    ...
    name: 'School Report Request (NRIC)',
    abbrev: 'SCH',
    color: '#6b7280',
    totalFields: 14,
    autoFilled: 10,
    pages: 1,
    turnaroundDays: 2,
    templateFile: '/report-templates/nric-report.docx',
    sections: [
      {
        id: 'nric-particulars',
        title: 'Student Particulars',
...
export const mockAgencyReports: Array<AgencyReport> = [
  ...
  },
  {
    ...
    studentId: '1',
    templateId: 'reach',
    templateName: 'REACH Student Information Form',
    agency: 'REACH',
