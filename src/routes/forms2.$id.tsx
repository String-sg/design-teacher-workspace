...
import { getForms2AnnouncementById } from '@/data/mock-forms2-announcements'
...
import { RecipientReadTable } from '@/components/forms2/recipient-read-table'
...
export const Route = createFileRoute('/forms2/$id')({
  loader: ({ params }) => {
    const announcement = getForms2AnnouncementById(params.id)
    if (!announcement) throw notFound()
    return { announcement }
  },
  component: Forms2DetailPage,
})
...
function Forms2DetailPage() {
  ...
  useSetBreadcrumbs([
    ...
    { label: announcement.title, href: `/forms2/${announcement.id}` },
  ])
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {isViewer ? (
            ...
            <Button
              ...
              size="sm"
              render={
                <Link to="/forms2/new" search={{ edit: announcement.id }} />
              }
            >
              Edit
            </Button>
